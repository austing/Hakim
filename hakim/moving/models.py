...
class CommandeParticulier(models.Model):
    ...
    origine_code = models.CharField(max_length=200, verbose_name="Code")
    origine_etages_sans_ascenseur = models.IntegerField(default=0,verbose_name="Etages sans ascenseur")
    destination_ville = models.CharField(max_length=200)
    destination_addresse = models.CharField(blank=True,max_length=200)
    destination_code = models.CharField(max_length=200, verbose_name="Code")
    destination_etages_sans_ascenseur = models.IntegerField(default=0,verbose_name="Etages sans ascenseur")
