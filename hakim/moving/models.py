...
class CommandeParticulier(models.Model):
    ...
    origine_etages_sans_ascenseur = models.IntegerField(verbose_name="Etages sans ascenseur")
    ...
    destination_etages_sans_ascenseur = models.IntegerField(verbose_name="Etages sans ascenseur")
